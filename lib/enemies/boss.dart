...
import '../decoration/flagDoor.dart';
...
class Boss extends SimpleEnemy with ObjectCollision {
  ...
  void update(double dt) {
    ...
    this.seeAndMoveToPlayer(
      ...
      radiusVision: tileSize * 10 * endConversation,
    );
    super.update(dt);
  }
  ...
  void addInitChild() {
    addImp(5680, 1003);
    addImp(5680, 1340); //position.bottom + tileSize);
  }
  ...
  void addDoor() {
    ...
    gameRef.add(FlagDoor(Vector2(dx, dy), size * 1.2));
  }
}
